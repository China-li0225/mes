<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="采购订单状态" prop="purchaseState">
        <el-input
          v-model="queryParams.purchaseState"
          placeholder="请输入采购订单状态"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="发起部门" prop="startDept">
        <el-input
          v-model="queryParams.startDept"
          placeholder="请输入发起部门"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="发起部门id" prop="startDeptId">
        <el-input
          v-model="queryParams.startDeptId"
          placeholder="请输入发起部门id"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
...
<!--      <el-table-column label="id" align="center" prop="id" v-if="true"/>-->
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="采购订单状态" prop="purchaseState">
          <el-input v-model="form.purchaseState" placeholder="请输入采购订单状态" />
        </el-form-item>
        <el-form-item label="发起部门" prop="startDept">
          <el-input v-model="form.startDept" placeholder="请输入发起部门" />
        </el-form-item>
        <el-form-item label="发起部门id" prop="startDeptId">
          <el-input v-model="form.startDeptId" placeholder="请输入发起部门id" />
        </el-form-item>
      </el-form>
...
<script>
import { listPurchaseOrder, getPurchaseOrder, delPurchaseOrder, addPurchaseOrder, updatePurchaseOrder } from "@/api/pr/purchase/purchaseOrder";
